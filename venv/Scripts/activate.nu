...
let virtual-env = "C:\Users\Наталія Коваль\PycharmProject\Training\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\Наталія Коваль\PycharmProject\Training\venv\Scripts\deactivate.nu"
